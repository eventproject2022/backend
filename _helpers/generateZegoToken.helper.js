...
exports.generateToken04 = (appId, userId, secret, effectiveTimeInSeconds, payload) => {
    ...
    var a = [new Uint8Array(8), new Uint8Array(2), new Uint8Array(2)], b1 = a[0], b2 = a[1], b3 = a[2];
